...
考试通知包括短信通知和邮件通知，提前导入考生后可批量或单个发送通知；

默认邮件通知内容包括：登陆时段、考试地址、准考证号；

默认短信通知包括：考试地址、准考证号；

注：短信通知为增值业务，仅付费用户可使用，短信通知和邮件通知内容均可定制（付费功能）。

邮件通知
````````````````````

考生信息填写有邮箱信息即可给考生发送邮件通知：

.. image:: _static/tz01.png

考前发送考试通知邮件需提前添加考生，可单个添加考生填写好考生邮件，或批量导入考生在导入表格里完善考生邮件信息；
...
1、即报即考自注册后给自动考生发送短信。通知内容包括考生准考证号；

2、预先添加考生，考前给考生发送通知短信。通知内容包括考生准考证号和考试地址。

.. image:: _static/tz02.png
...
考生信息字段可设置改信息项的提示语，以及进行信息分组显示。

.. image:: _static/b-01.png

.. image:: _static/b-02.png

高级设置在考生界面的样式如下：

.. image:: _static/b-03.png
